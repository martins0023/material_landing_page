...
export function CarouselFeatures() {
  return (
    <section className="px-8 pt-40 pb-20">
      ...
      <div className="container mx-auto !rounded-lg bg-[url('/image/Flower5.jpg')] bg-center py-10 lg:px-16">
        <Carousel
            ...
            >
              <div className="col-span-3 flex flex-col items-start justify-center">
                ...
                >
                  ...
                  and contribute to 
                  the research, and join the exciting journey of 
                  advancing deep learning applications in the field of botany.
                </Typography>
                <Typography
                  variant="small"
                  color="white"
                ...
                >
                  ...
                  <span className="font-normal opacity-60">
                    SOFTWARE DEVELOPER & DESIGNER <br/>@ CLINIC ONLINE.
                  </span>
                </Typography>
              </div>
