    ...
    <div className="grid min-h-screen place-items-center">
      <section className="container mx-auto px-10">
        <div className="grid place-items-center pb-20 text-center">
          <Typography variant="h2" color="blue-gray" {...({} as any)}>
            Best no-tricks pricing
          </Typography>
          <Typography variant="lead" className="mt-2 !text-gray-500 lg:w-5/12" {...({} as any)}>
          ...
          <CardBody>
            ...
            <div className="grid grid-cols-1 items-center gap-20 lg:grid-cols-2">
              ...
              <div className="grid place-items-center lg:justify-end">
                ...
                <Typography variant="h1" color="blue-gray" {...({} as any)}>
                  $399
                </Typography>
                <Button color="gray" className="my-3" {...({} as any)}>
                  get access
                </Button>
                <Typography
                  variant="small"
